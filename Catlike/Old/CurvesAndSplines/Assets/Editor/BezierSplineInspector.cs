...
public class BezierSplineInspector : Editor
{
    ...
    private void ShowDirections()
    {
        ...
        // We can improve the visualization by making sure that each curve segment gets the same amount of lines.
    ...
    private Vector3 ShowPoint(int index)
    {
        ...
        // It is tough to get a good size for the dots. Depending on the scale you're working at, they could end up either too large or too small.
        // It would be nice if we could keep the screen size of the dots fixed, just like the position handles always have the same screen size.
        // We can do this by factoring in HandleUtility.GetHandleSize. This method gives us a fixed screen size for any point in world space.
