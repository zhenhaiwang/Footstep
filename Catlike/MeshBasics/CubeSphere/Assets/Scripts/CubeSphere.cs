...
public class CubeSphere : MonoBehaviour
{
    ...
    /// <summary>
    /// To create a unit sphere – a sphere with a radius of 1 unit – we need to normalize the vertices of a cube that is centered at the origin.
    /// For that cube to exactly contain the sphere, it needs to have edge length 2.
    /// </summary>
    private void SetVertex(int i, int x, int y, int z)
    {
        Vector3 v = new Vector3(x, y, z) * 2f / gridSize - Vector3.one;
        // This is really a mathematical problem.
        float x2 = v.x * v.x;
        float y2 = v.y * v.y;
        float z2 = v.z * v.z;
        Vector3 s;
